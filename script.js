...
var driveurl = "";
const CURRENT_YEAR = 2026; // UPDATE: change max year. (Add 1)
const DBPAGEID_MAX = 116776; // UPDATE: change default year on load. (Add 1)
...
var reeldata = [
  ...
  [1, 3, 0, 802702, 7, 1, "zip"],
  [2, 4, 0, 801409, 20, 469, "zip"],
  [3, 4, 90, 801408, 5, 1163, "tar"],
  [4, 3, 0, 802605, 33, 2008, "zip"],
  [5, 3, 0, 601009, 3, 2731, "zip"],
  [6, 4, 0, 801407, 4, 3426, "zip"],
  [7, 4, 0, 801406, 30, 4153, "zip"],
  [8, 4, 90, 802708, 25, 4817, "zip"],
  [9, 3, 0, 802609, 9, 5522, "zip"],
  [10, 4, 0, 802709, 31, 6229, "tar"],
  [11, 4, 0, 802703, 18, 6966, "zip"],
  [12, 4, 0, 801406, 32, 7645, "zip"],
  [13, 4, 90, 802701, 21, 8322, "zip"],
  [14, 3, 0, 802705, 18, 9008, "zip"],
  [15, 3, 0, 801408, 22, 9609, "zip"],
  [16, 3, 0, 801408, 17, 10259, "zip"],
  [17, 3, 0, 801406, 35, 10873, "zip"],
  [18, 4, 0, 802604, 17, 11617, "zip"],
  [19, 4, 90, 801406, 20, 12373, "zip"],
  [20, 4, 90, 802605, 2, 12924, "zip"],
  [21, 4, 270, 902605, 29, 13631, "zip"],
  [22, 5, 0, 802606, 12, 14313, "zip"],
  [23, 4, 270, 802703, 25, 14989, "zip"],
  [24, 5, 0, 601406, 31, 15703, "zip"],
  [25, 3, 0, 801407, 25, 16530, "zip"],
  [26, 6, 0, 802704, 32, 17246, "zip"],
  [27, 4, 0, 802706, 27, 17873, "zip"],
  [28, 4, 0, 902205, 9, 18506, "zip"],
  [29, 3, 0, 802703, 19, 18982, "zip"],
  [30, 4, 270, 802608, 27, 19578, "zip"],
  [31, 4, 0, 801403, 6, 20184, "zip"],
  [32, 4, 0, 802700, 21, 20787, "zip"],
  [33, 4, 0, 802700, 8, 21391, "zip"],
  [34, 4, 90, 802706, 18, 22009, "zip"],
  [35, 6, 0, 802609, 20, 22627, "zip"],
  [36, 5, 0, 800100, 18, 23235, "zip"],
  [37, 3, 0, 601408, 22, 23851, "zip"],
  [38, 3, 0, 802608, 23, 24459, "zip"],
  [39, 3, 0, 601408, 30, 25060, "zip"],
  [40, 3, 0, 801407, 32, 25668, "zip"],
  [41, 4, 0, 601408, 20, 26261, "zip"],
  [42, 4, 0, 801407, 24, 26861, "zip"],
  [43, 4, 0, 801409, 11, 27485, "zip"],
  [44, 2, 0, 802607, 32, 28111, "zip"],
  [45, 3, 0, 802706, 26, 28720, "zip"],
  [46, 3, 0, 601403, 24, 29334, "zip"],
  [47, 3, 0, 601409, 30, 29960, "zip"],
  [48, 3, 0, 802606, 21, 30570, "zip"],
  [49, 3, 0, 802707, 16, 31197, "zip"],
  [50, 6, 0, 802700, 29, 31835, "zip"],
  [51, 3, 0, 801409, 26, 32442, "zip"],
  [52, 4, 0, 801309, 26, 33065, "zip"],
  [53, 4, 0, 802705, 14, 33683, "zip"],
  [54, 6, 0, 902205, 34, 34026, "zip"],
  [55, 5, 0, 801409, 16, 34481, "zip"],
  [56, 6, 0, 802609, 20, 34872, "zip"],
  [57, 6, 0, 902606, 14, 35447, "zip"],
  [58, 6, 0, 601406, 29, 35893, "zip"],
  [59, 6, 0, 801406, 1, 36257, "zip"],
  [60, 6, 0, 801403, 34, 36890, "zip"],
  [61, 6, 0, 601409, 9, 37383, "zip"],
  [62, 3, 0, 802605, 29, 38218, "zip"],
  [63, 6, 0, 802709, 27, 38840, "zip"],
  [64, 6, 0, 601408, 28, 39511, "tar"],
  [65, 7, 0, 802703, 12, 40274, "zip"],
  [66, 5, 0, 802605, 34, 40511, "zip"],
  [67, 5, 0, 802608, 6, 41157, "tar"],
  [68, 5, 0, 802708, 1, 41802, "zip"],
  [69, 5, 0, 801406, 33, 42264, "zip"],
  [70, 6, 0, 802704, 15, 42774, "tar"],
  [71, 7, 270, 802704, 30, 43452, "tar"],
  [72, 6, 0, 802608, 8, 44123, "zip"],
  [73, 5, 0, 801408, 20, 44690, "tar"],
  [74, 6, 0, 802706, 6, 45475, "tar"],
  [75, 4, 0, 802702, 20, 46211, "zip"],
  [76, 7, 0, 801407, 10, 46840, "zip"],
  [77, 6, 0, 902706, 8, 47735, "tar"],
  [78, 6, 0, 802706, 31, 48528, "zip"],
  [79, 6, 0, 902205, 0, 49174, "tar"],
  [80, 6, 0, 802704, 29, 50080, "tar"],
  [81, 5, 0, 902604, 20, 50866, "zip"],
  [82, 6, 0, 802700, 21, 51465, "tar"],
  [83, 3, 0, 802608, 29, 52376, "tar"],
  [84, 7, 0, 802607, 32, 53156, "tar"],
  [85, 5, 0, 902205, 6, 53815, "tar"],
  [86, 8, 0, 800301, 12, 54725, "tar"],
  [87, 7, 0, 802702, 24, 55533, "zip"],
  [88, 7, 0, 801406, 5, 56159, "tar"],
  [89, 7, 0, 802705, 26, 56888, "zip"],
  [90, 6, 0, 601409, 24, 57040, "tar"],
  [91, 5, 0, 801407, 31, 57995, "tar"],
  [92, 5, 0, 802707, 10, 58672, "tar"],
  [93, 4, 0, 802605, 21, 59409, "zip"],
  [94, 4, 0, 801409, 6, 59559, "tar"],
  [95, 5, 0, 802205, 0, 60450, "zip"],
  [96, 4, 0, 601409, 0, 61148, "tar"],
  [97, 2, 0, 902700, 9, 61963, "zip"],
  [98, 5, 0, 801403, 3, 62212, "tar"],
  [99, 4, 0, 801409, 0, 63199, "tar"],
  [100, 5, 0, 802707, 14, 63944, "zip"],
  [101, 5, 0, 902605, 23, 64681, "zip"],
  [102, 4, 0, 802605, 25, 64867, "tar"],
  [103, 5, 0, 902704, 33, 65718, "tar"],
  [104, 4, 0, 802205, 30, 66462, "zip"],
  [105, 2, 0, 801406, 0, 66695, "zip"],
  [106, 7, 0, 802707, 34, 67301, "zip"],
  [107, 2, 0, 801407, 7, 67526, "tar"],
  [108, 3, 0, 801407, 26, 68506, "zip"],
  [109, 2, 0, 802205, 3, 69202, "tar"],
  [110, 4, 0, 601407, 21, 70050, "zip"],
  [111, 8, 0, 601408, 31, 70280, "zip"],
  [112, 1, 0, 802606, 34, 70894, "zip"],
  [113, 6, 0, 802609, 13, 71295, "tar"],
  [114, 5, 0, 802607, 24, 72139, "zip"],
  [115, 5, 0, 802707, 6, 72642, "zip"],
  [116, 6, 0, 802606, 4, 73130, "zip"],
  [117, 8, 0, 802607, 11, 73409, "zip"],
  [118, 562, 0, 902701, 2, 73852, "zip"],
  [119, 7, 0, 801408, 17, 74414, "zip"],
  [120, 7, 0, 802605, 28, 74847, "zip"],
  [121, 6, 0, 802607, 20, 75337, "zip"],
  [122, 6, 0, 902607, 27, 75600, "tar"],
  [123, 6, 0, 802705, 9, 76350, "zip"],
  [124, 614, 0, 801409, 12, 76567, "zip"],
  [125, 7, 0, 801409, 3, 77180, "zip"],
  [126, 7, 0, 801406, 20, 77673, "zip"],
  [127, 7, 0, 802604, 16, 78235, "zip"],
  [128, 8, 0, 802609, 17, 78624, "zip"],
  [129, 8, 0, 801408, 15, 79137, "zip"],
  [130, 7, 0, 801406, 1, 79702, "zip"],
  [131, 7, 0, 802704, 22, 79929, "tar"],
  [132, 7, 0, 801409, 12, 80561, "zip"],
  [133, 7, 0, 802604, 35, 81082, "zip"],
  [134, 6, 0, 801409, 22, 81981, "zip"],
  [135, 7, 0, 902606, 34, 82522, "zip"],
  [136, 8, 0, 801409, 32, 82959, "zip"],
  [137, 7, 0, 802707, 3, 83166, "zip"],
  [138, 6, 0, 802608, 15, 83859, "zip"],
  [139, 6, 0, 902701, 19, 84266, "zip"],
  [140, 6, 0, 801006, 22, 84678, "zip"],
  [141, 7, 0, 802705, 32, 85131, "zip"],
  [142, 7, 0, 802705, 23, 85761, "zip"],
  [143, 6, 0, 801403, 21, 86146, "zip"],
  [144, 6, 0, 801407, 35, 86305, "zip"],
  [145, 1, 0, 801403, 1, 86927, "zip"],
  [146, 8, 0, 802605, 2, 87316, "zip"],
  [147, 8, 0, 902703, 13, 88065, "zip"],
  [148, 8, 0, 801406, 31, 88494, "zip"],
  [149, 8, 0, 801407, 0, 88967, "zip"],
  [150, 10, 0, 801408, 2, 89140, "zip"],
  [151, 10, 0, 802704, 34, 89634, "zip"],
  [152, 6, 0, 802701, 28, 90100, "zip"],
  [153, 7, 0, 801409, 31, 90880, "zip"],
  [154, 7, 0, 801407, 5, 91311, "zip"],
  [155, 6, 0, 802609, 9, 91732, "zip"],
  [156, 6, 0, 801408, 17, 91909, "zip"],
  [157, 7, 0, 802706, 14, 92479, "zip"],
  [158, 6, 0, 902706, 34, 92906, "zip"],
  [159, 5, 0, 802704, 9, 93345, "zip"],
  [160, 8, 0, 802608, 15, 93716, "zip"],
  [161, 8, 0, 801406, 35, 94387, "zip"],
  [162, 6, 0, 801408, 16, 94630, "zip"],
  [163, 7, 0, 802700, 18, 94839, "zip"],
  [164, 7, 0, 802702, 4, 95532, "zip"],
  [165, 6, 0, 902205, 21, 95834, "zip"],
  [166, 6, 0, 802705, 13, 96133, "zip"],
  [167, 6, 0, 601406, 27, 96654, "tar"],
  [168, 6, 0, 802205, 26, 97579, "zip"],
  [169, 6, 0, 902700, 17, 97756, "tar"],
  [170, 6, 0, 601405, 21, 98828, "zip"],
  [171, 6, 0, 802700, 7, 99649, "tar"],
  [172, 6, 0, 801408, 16, 100724, "zip"],
  [173, 6, 0, 802606, 3, 100919, "zip"],
  [174, 6, 0, 802705, 16, 101500, "zip"],
  [175, 6, 0, 801407, 18, 102158, "zip"],
  [176, 6, 0, 802607, 24, 102674, "zip"],
  [177, 5, 0, 801407, 12, 103106, "zip"],
  [178, 6, 0, 902607, 12, 104123, "zip"],
  [179, 5, 0, 801407, 13, 104290, "tar"],
  [180, 5, 0, 802604, 20, 105344, "tar"],
  [181, 7, 0, 802704, 9, 106113, "tar"],
  [182, 6, 0, 802704, 19, 107006, "zip"],
  [183, 7, 0, 802707, 24, 107167, "zip"],
  [184, 5, 0, 600202, 25, 107805, "zip"],
  [185, 7, 0, 802205, 2, 108315, "tar"],
  [186, 6, 0, 802605, 26, 109183, "tar"],
  [187, 6, 0, 802702, 10, 110175, "zip"],
  [188, 6, 0, 802604, 9, 110370, "zip"],
  [189, 7, 0, 801407, 6, 110891, "zip"],
  [190, 7, 0, 802704, 10, 111689, "zip"],
  [191, 7, 0, 800202, 25, 112565, "zip"],
  [192, 7, 0, 800200, 12, 112748, "zip"],
  [193, 7, 0, 802701, 4, 113305, "zip"],
  [194, 7, 0, 802606, 33, 113691, "zip"],
  [195, 7, 90, 801006, 24, 114431, "zip"],
  [196, 6, 0, 802605, 24, 114801, "zip"],
  [197, 6, 0, 801406, 3, 115404, "zip"],
  [198, 6, 0, 801407, 17, 115611, "zip"],
  [199, 6, 0, 601408, 14, 116153, "zip"],
];
...
function loadnewpage() {
  ...
  if (
    ...
    var folderlist = [
      ...
      "13IBUJiFaSVvltysgtNL5HjkXND1j1e4g",
    ];
